...
<div class="container">
       <!-- Form to add User -->
       <h3>Add New Coment</h3>
       <form action="?controller=coments&action=add&id=<?=$_SESSION['for_id']?>" method="post" enctype="multipart/form-data">
           <div class="row">
               <div class="field">
                   <label>Text: <input type="text" name="textc"></label>
               </div>
           </div>
